...
sigma = 5.67e-8      # Constante de Stefan-Boltzmann (W/m²·K⁴)
         # Capacité thermique constante (J/K·m²)
...
# === Capacité thermique approximative des régions (J/K·m²) ===
data_capacite_thermique = {
    "Amérique du Nord": 2.0e5,
    "Amérique du Sud": 2.3e5,
    "Europe de l'Ouest": 2.1e5,
    "Europe de l'Est": 2.2e5,
    "Asie du Sud": 2.5e5,
    "Asie de l'Est": 2.4e5,
    "Asie du Sud-Est": 2.6e5,
    "Afrique du Nord": 1.8e5,
    "Afrique Sub-saharienne": 2.3e5,
    "Afrique_Désertique": 1.2e5,
    "Océans": 4.2e5,
    "Pole Nord": 2.0e5,
    "Pole Sud": 2.1e5
}
...
def obtenir_capacite_thermique(lat, lon):
    zone = determiner_partie_terre(lat, lon)
    return data_capacite_thermique[zone]
...
def temp_evolution(latitude, longitude, jour):
    ...
    c = obtenir_capacite_thermique(latitude, longitude)  # ← nouveau
    T = [T0]
    for i in range(24):
...
plt.title("Évolution de la température sur 24h (jour {jour})")
plt.grid()
